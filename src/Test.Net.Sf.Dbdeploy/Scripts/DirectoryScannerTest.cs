...
namespace Net.Sf.Dbdeploy.Scripts
{
    ...
    public class DirectoryScannerTest
    {
        ...
        public void CanOrderFilesWithoutLeadingZeros()
        {
            ...
            Assert.AreEqual("8.Create Product Table.sql", changeScripts[0].GetDescription(), "8.Create Product Table.sql should be first.");
            Assert.AreEqual("09.Add Product Data.sql", changeScripts[1].GetDescription(), "09.Add Product Data.sql should be second.");
            Assert.AreEqual("10.Add Sold Column.sql", changeScripts[2].GetDescription(), "10.Add Sold Column.sql should be last.");
